...
app = typer.Typer(
    name="velaris",
    help=(
        "Velaris Agent Python runtime, based on OpenHarness.\n\n"
        "Starts an interactive session by default, use -p/--print for non-interactive output.\n"
        "Compatibility entrypoints `oh` and `openharness` remain available during migration."
    ),
...
demo_app = typer.Typer(name="demo", help="Run local built-in demos")
